...
public class AuthService {
    ...
    public AuthToken login(String username, String password, String clientId, String clientSecret) {
        ...
        boolean saveTokenResult = this.saveToken(authToken.getAccess_token(), content, tokenValiditySeconds);
        if(!saveTokenResult){
            CustomExceptionCast.cast(AuthCode.AUTH_LOGIN_ERROR);
        }
        return authToken;
    ...
    private AuthToken applyToken(String username,String password,String clientId,String clientSecret){
        //选中认证服务的地址
        ServiceInstance serviceInstance = loadBalancerClient.choose(NmServiceList.XC_SERVICE_UCENTER_AUTH);
